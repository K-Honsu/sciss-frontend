...
import { CreateLink } from "../../../hooks/useCreateLinkForNonAuth";
...
function HeroSection() {
  ...
  const { AnonCreateLink, data } = CreateLink();
        ...
        <h1 className="text-dark-700 text-7xl font-bold leading-[118%]">
          <span className="inline-flex gap-x-2">
            ...
            <motion.span
              ...
              animate={{ opacity: 1 }}
              className="text-primary self-end overflow-hidden"
            >
              <AnimatedLink title="Clutter," isLink={false} />
            </motion.span>
          </span>
        ...
        <div>
          ...
          <div className="relative min-w-96 rounded-[20px] rounded-tl-none px-8 py-6 border-4 border-neutral shadow-[4px_4px_0px_0px] shadow-primary-200 flex flex-col gap-y-8">
            <div className="left-16 -z-10 -top-2 absolute w-[350px] -translate-y-full aspect-[20/13]">
              <img src="icons/trail_1.svg" fill="layout" />
            </div>
            <div className="-right-16 -z-10 -bottom-4 translate-y-full absolute w-[300px] aspect-[17/13]">
              <img src="icons/trail_2.svg" fill="layout" />
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-dark-500 text-xl font-semibold">
                Paste a long URL
              </span>
              <input
            ...
            <div className="flex gap-2 items-end">
              ...
              <div className="basis-full flex flex-col gap-2">
                ...
                <input
                  className="p-4 border-2 transition-colors ease-in border-neutral rounded-lg focus:border-primary outline-none"
                  placeholder="Enter a suitable alias name"
                  name="url"
                  value={alias}
